  ...
  modules: [
    {
      ...
      mimlos: [
        {
          id: "mimlo_sd_1",
          text: "Design and implement object-oriented software solutions using industry-standard programming languages",
        },
        {
          id: "mimlo_sd_2",
          text: "Apply software development methodologies to manage the software development lifecycle",
        },
        {
          id: "mimlo_sd_3",
          text: "Evaluate and select appropriate data structures and algorithms for specific problem domains",
        },
        {
          id: "mimlo_sd_4",
          text: "Demonstrate proficiency in version control and collaborative development practices",
        },
      ],
      assessments: [
        {
    ...
    },
    {
      ...
      mimlos: [
        {
          id: "mimlo_db_1",
          text: "Design normalised relational database schemas using entity-relationship modelling",
        },
        { id: "mimlo_db_2", text: "Implement and query databases using SQL" },
        {
          id: "mimlo_db_3",
          text: "Evaluate database performance and apply indexing strategies",
        },
      ],
      assessments: [
        {
...
const moduleEditorViewData = {
  ...
  modules: [
    {
      ...
      mimlos: [
        {
          id: "mimlo_sd_1",
          text: "Design and implement object-oriented software solutions",
        },
      ],
      assessments: [],
    },
  ...
  plos: [
    {
      id: "plo_1",
      text: "Design, develop and test software applications",
      standardMappings: [],
    },
    {
      id: "plo_2",
      text: "Apply software engineering methodologies",
      standardMappings: [],
    },
    {
      id: "plo_3",
      text: "Design and implement database solutions",
      standardMappings: [],
    },
    {
      id: "plo_4",
      text: "Create responsive web applications",
      standardMappings: [],
    },
    {
      id: "plo_5",
      text: "Demonstrate understanding of computer architecture",
      standardMappings: [],
    },
    {
      id: "plo_6",
      text: "Work effectively in agile teams",
      standardMappings: [],
    },
  ],
  ploToModules: {
...
const programmeWithElectives = {
  ...
  modules: [
    {
      ...
      credits: 10,
      type: "M",
      mimlos: [{ id: "mimlo_c1_1", text: "Apply research methodologies" }],
      assessments: [],
    },
    {
      id: "mod_core2",
  ...
  plos: [
    ...
    {
      id: "plo_2",
      text: "Design advanced software solutions",
      standardMappings: [],
    },
    {
      id: "plo_3",
      text: "Apply specialized knowledge in chosen track",
      standardMappings: [],
    },
    {
      id: "plo_4",
      text: "Evaluate emerging technologies",
      standardMappings: [],
    },
    { id: "plo_5", text: "Lead technical teams", standardMappings: [] },
    {
      id: "plo_6",
      text: "Communicate technical concepts effectively",
      standardMappings: [],
    },
  ],
  ploToModules: {
